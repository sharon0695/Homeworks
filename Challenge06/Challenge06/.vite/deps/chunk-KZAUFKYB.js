import {
  d as d2
} from "./chunk-UISUXF73.js";
import {
  d
} from "./chunk-GLKL36NM.js";
import {
  P,
  f,
  h,
...
var h2 = async (n3) => {
  if (n3.leavingEl && n3.animated && 0 !== n3.duration) return n3.animationBuilder ? n3.animationBuilder : "ios" === n3.mode ? (await import("./p-CBzELu-H-SXIXTLO2.js")).iosTransitionAnimation : (await import("./p-CU1SSH8_-VF4I2DIU.js")).mdTransitionAnimation;
};
var y = async (n3, e) => {
  await k(e, true);
...
//# sourceMappingURL=chunk-KZAUFKYB.js.map
